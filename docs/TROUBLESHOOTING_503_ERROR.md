...
## Symptôme
```
GET https://jobflow-manager-7.preview.emergentagent.com/api/besoins?page=1&page_size=12 
...
fetch('https://jobflow-manager-7.preview.emergentagent.com/health')
  .then(r => r.json())
  .then(console.log)
  .catch(console.error)
```
...
fetch('https://jobflow-manager-7.preview.emergentagent.com/api/besoins?page=1&page_size=12', {
