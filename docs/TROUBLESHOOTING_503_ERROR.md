...
## Symptôme
```
GET https://dynamicconfig.preview.emergentagent.com/api/besoins?page=1&page_size=12 
...
fetch('https://dynamicconfig.preview.emergentagent.com/health')
  .then(r => r.json())
  .then(console.log)
  .catch(console.error)
```
...
```bash
# Login
fetch('https://dynamicconfig.preview.emergentagent.com/api/auth/local/login', {
  method: 'POST',
...
fetch('https://dynamicconfig.preview.emergentagent.com/api/besoins?page=1&page_size=12', {
