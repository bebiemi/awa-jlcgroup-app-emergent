...
## Symptôme
```
GET https://entsynchro.preview.emergentagent.com/api/besoins?page=1&page_size=12 
...
fetch('https://entsynchro.preview.emergentagent.com/health')
  .then(r => r.json())
  .then(console.log)
  .catch(console.error)
```
...
fetch('https://entsynchro.preview.emergentagent.com/api/besoins?page=1&page_size=12', {
