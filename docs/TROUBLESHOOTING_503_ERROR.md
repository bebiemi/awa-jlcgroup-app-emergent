...
## Symptôme
```
GET https://bizman-portal.preview.emergentagent.com/api/besoins?page=1&page_size=12 
...
fetch('https://bizman-portal.preview.emergentagent.com/health')
  .then(r => r.json())
  .then(console.log)
  .catch(console.error)
```
...
fetch('https://bizman-portal.preview.emergentagent.com/api/besoins?page=1&page_size=12', {
