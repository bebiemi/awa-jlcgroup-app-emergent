...
1. **Ouvrir la Console DevTools** sur `https://dynamicconfig.preview.emergentagent.com`

2. **Vérifier les requêtes dans l'onglet Network**:
   ```
   ✅ BON: https://dynamicconfig.preview.emergentagent.com/api/config/countries
...
│ User Browser (HTTPS)                                         │
│   ↓                                                          │
│ https://dynamicconfig.preview.emergentagent.com/admin/countries       │
└──────────────────────────────────────────────────────────────┘
                        ↓
┌──────────────────────────────────────────────────────────────┐
