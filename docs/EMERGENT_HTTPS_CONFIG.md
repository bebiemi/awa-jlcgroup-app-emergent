...
1. **Ouvrir la Console DevTools** sur `https://xxx.preview.emergentagent.com`

2. **Vérifier les requêtes dans l'onglet Network**:
   ```
   ✅ BON: https://xxx.preview.emergentagent.com/api/config/countries
...
│ User Browser (HTTPS)                                         │
│   ↓                                                          │
│ https://xxx.preview.emergentagent.com/admin/countries       │
└──────────────────────────────────────────────────────────────┘
                        ↓
┌──────────────────────────────────────────────────────────────┐
