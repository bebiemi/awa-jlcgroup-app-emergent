...
1. **Ouvrir la Console DevTools** sur `https://security-mend.preview.emergentagent.com`

2. **Vérifier les requêtes dans l'onglet Network**:
   ```
   ✅ BON: https://security-mend.preview.emergentagent.com/api/config/countries
...
│ User Browser (HTTPS)                                         │
│   ↓                                                          │
│ https://security-mend.preview.emergentagent.com/admin/countries       │
└──────────────────────────────────────────────────────────────┘
                        ↓
┌──────────────────────────────────────────────────────────────┐
