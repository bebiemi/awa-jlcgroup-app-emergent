...
1. **Ouvrir la Console DevTools** sur `https://jobflow-18.preview.emergentagent.com`

2. **Vérifier les requêtes dans l'onglet Network**:
   ```
   ✅ BON: https://jobflow-18.preview.emergentagent.com/api/config/countries
...
│ User Browser (HTTPS)                                         │
│   ↓                                                          │
│ https://jobflow-18.preview.emergentagent.com/admin/countries       │
└──────────────────────────────────────────────────────────────┘
                        ↓
┌──────────────────────────────────────────────────────────────┐
