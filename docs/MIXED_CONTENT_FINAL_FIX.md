...
```
Mixed Content: The page at 'https://bizman-portal.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://bizman-portal.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://bizman-portal.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://bizman-portal.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://bizman-portal.preview.emergentagent.com/api/config/countries`
