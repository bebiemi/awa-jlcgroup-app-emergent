...
```
Mixed Content: The page at 'https://dynamicconfig.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://dynamicconfig.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://dynamicconfig.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://dynamicconfig.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://dynamicconfig.preview.emergentagent.com/api/config/countries`
