...
### En Production (HTTPS)
```
Page: https://configdriven-app.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://configdriven-app.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://configdriven-app.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://configdriven-app.preview.emergentagent.com/api/config/countries`
