...
```
Mixed Content: The page at 'https://workflow-mapper-6.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://workflow-mapper-6.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://workflow-mapper-6.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://workflow-mapper-6.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://workflow-mapper-6.preview.emergentagent.com/api/config/countries`
