...
```
Mixed Content: The page at 'https://config-nav-sidebar.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://config-nav-sidebar.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://config-nav-sidebar.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://config-nav-sidebar.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://config-nav-sidebar.preview.emergentagent.com/api/config/countries`
