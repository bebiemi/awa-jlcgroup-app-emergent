...
### En Production (HTTPS)
```
Page: https://safe-permission-sys.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://safe-permission-sys.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://safe-permission-sys.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://safe-permission-sys.preview.emergentagent.com/api/config/countries`
