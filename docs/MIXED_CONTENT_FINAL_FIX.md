...
```
Mixed Content: The page at 'https://identity-refresh-2.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://identity-refresh-2.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://identity-refresh-2.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://identity-refresh-2.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://identity-refresh-2.preview.emergentagent.com/api/config/countries`
