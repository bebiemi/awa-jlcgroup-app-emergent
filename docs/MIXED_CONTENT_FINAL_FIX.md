...
```
Mixed Content: The page at 'https://postulant-app.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://postulant-app.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://postulant-app.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://postulant-app.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://postulant-app.preview.emergentagent.com/api/config/countries`
