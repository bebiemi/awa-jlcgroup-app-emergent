...
```
Mixed Content: The page at 'https://csv-import-export.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://csv-import-export.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://csv-import-export.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://csv-import-export.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://csv-import-export.preview.emergentagent.com/api/config/countries`
