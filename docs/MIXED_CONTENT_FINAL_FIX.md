...
```
Mixed Content: The page at 'https://iam-migrate.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://iam-migrate.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://iam-migrate.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://xxx.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://xxx.preview.emergentagent.com/api/config/countries`
