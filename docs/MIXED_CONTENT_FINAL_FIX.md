...
```
Mixed Content: The page at 'https://entsynchro.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://entsynchro.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://entsynchro.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://entsynchro.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://entsynchro.preview.emergentagent.com/api/config/countries`
