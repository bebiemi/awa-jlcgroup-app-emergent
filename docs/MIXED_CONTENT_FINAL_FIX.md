...
```
Mixed Content: The page at 'https://app-refactor-3.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://app-refactor-3.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://app-refactor-3.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://app-refactor-3.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://app-refactor-3.preview.emergentagent.com/api/config/countries`
