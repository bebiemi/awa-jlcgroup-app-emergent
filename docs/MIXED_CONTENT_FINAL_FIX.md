...
```
Mixed Content: The page at 'https://dev-stabilizer.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://dev-stabilizer.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://dev-stabilizer.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://dev-stabilizer.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://dev-stabilizer.preview.emergentagent.com/api/config/countries`
