...
```
Mixed Content: The page at 'https://id-manager-4.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://id-manager-4.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://id-manager-4.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://id-manager-4.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://id-manager-4.preview.emergentagent.com/api/config/countries`
