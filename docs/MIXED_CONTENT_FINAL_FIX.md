...
```
Mixed Content: The page at 'https://backend-bugfix-ops.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://backend-bugfix-ops.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://backend-bugfix-ops.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://backend-bugfix-ops.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://backend-bugfix-ops.preview.emergentagent.com/api/config/countries`
