...
```
Mixed Content: The page at 'https://docker-auth-rescue.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://docker-auth-rescue.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://docker-auth-rescue.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://docker-auth-rescue.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://docker-auth-rescue.preview.emergentagent.com/api/config/countries`
