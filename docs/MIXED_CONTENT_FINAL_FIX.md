...
### En Production (HTTPS)
```
Page: https://identity-manager-5.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://identity-manager-5.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://identity-manager-5.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://identity-manager-5.preview.emergentagent.com/api/config/countries`
