...
### En Production (HTTPS)
```
Page: https://bugs-to-bugs.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://bugs-to-bugs.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://bugs-to-bugs.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://bugs-to-bugs.preview.emergentagent.com/api/config/countries`
