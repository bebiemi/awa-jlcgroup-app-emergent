...
```
Mixed Content: The page at 'https://role-based-security.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://role-based-security.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://role-based-security.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://role-based-security.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://role-based-security.preview.emergentagent.com/api/config/countries`
