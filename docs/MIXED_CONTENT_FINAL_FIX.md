...
```
Mixed Content: The page at 'https://recruitmatch-2.preview.emergentagent.com/admin/countries' 
...
### En Production (HTTPS)
```
Page: https://recruitmatch-2.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://recruitmatch-2.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://recruitmatch-2.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://recruitmatch-2.preview.emergentagent.com/api/config/countries`
