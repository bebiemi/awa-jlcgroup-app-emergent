...
### En Production (HTTPS)
```
Page: https://api-harmony-4.preview.emergentagent.com/admin/countries
Requête: /api/config/countries
Résolu en: https://api-harmony-4.preview.emergentagent.com/api/config/countries
...
2. En **production**: Aller sur `https://api-harmony-4.preview.emergentagent.com/admin/countries`
   - ✅ Doit charger les pays
   - ✅ Network tab doit montrer: `https://api-harmony-4.preview.emergentagent.com/api/config/countries`
