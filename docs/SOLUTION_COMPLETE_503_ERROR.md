...
### Analyse
```
Browser → https://auth-secure-1.preview.emergentagent.com/api/besoins
          ↓
...
### Preuve
```bash
curl https://auth-secure-1.preview.emergentagent.com/health
...
│  https://auth-secure-1.preview.emergentagent.com │
└───────────────────────┬─────────────────────────────┘
                        │
                        ▼
┌─────────────────────────────────────────────────────┐
