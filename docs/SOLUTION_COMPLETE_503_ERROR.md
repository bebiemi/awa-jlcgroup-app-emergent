...
### Analyse
```
Browser → https://config-nav-sidebar.preview.emergentagent.com/api/besoins
          ↓
...
### Preuve
```bash
curl https://config-nav-sidebar.preview.emergentagent.com/health
...
│  https://config-nav-sidebar.preview.emergentagent.com │
└───────────────────────┬─────────────────────────────┘
                        │
                        ▼
┌─────────────────────────────────────────────────────┐
