...
### Analyse
```
Browser → https://backend-bugfix-ops.preview.emergentagent.com/api/besoins
          ↓
...
### Preuve
```bash
curl https://backend-bugfix-ops.preview.emergentagent.com/health
...
│  https://backend-bugfix-ops.preview.emergentagent.com │
└───────────────────────┬─────────────────────────────┘
                        │
                        ▼
┌─────────────────────────────────────────────────────┐
