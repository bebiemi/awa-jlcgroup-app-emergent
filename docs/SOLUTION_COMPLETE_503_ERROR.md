...
### Analyse
```
Browser → https://workflow-mapper-6.preview.emergentagent.com/api/besoins
          ↓
...
### Preuve
```bash
curl https://workflow-mapper-6.preview.emergentagent.com/health
...
│  https://workflow-mapper-6.preview.emergentagent.com │
└───────────────────────┬─────────────────────────────┘
                        │
                        ▼
┌─────────────────────────────────────────────────────┐
