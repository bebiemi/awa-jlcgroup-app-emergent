...
### Analyse
```
Browser → https://id-manager-4.preview.emergentagent.com/api/besoins
          ↓
...
### Preuve
```bash
curl https://id-manager-4.preview.emergentagent.com/health
...
│  https://id-manager-4.preview.emergentagent.com │
└───────────────────────┬─────────────────────────────┘
                        │
                        ▼
┌─────────────────────────────────────────────────────┐
