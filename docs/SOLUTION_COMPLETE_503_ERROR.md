...
### Analyse
```
Browser → https://recruitmatch-2.preview.emergentagent.com/api/besoins
          ↓
...
### Preuve
```bash
curl https://recruitmatch-2.preview.emergentagent.com/health
...
│  https://recruitmatch-2.preview.emergentagent.com │
└───────────────────────┬─────────────────────────────┘
                        │
                        ▼
┌─────────────────────────────────────────────────────┐
