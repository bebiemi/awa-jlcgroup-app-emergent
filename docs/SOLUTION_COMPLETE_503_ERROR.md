...
### Analyse
```
Browser → https://dev-stabilizer.preview.emergentagent.com/api/besoins
          ↓
...
### Preuve
```bash
curl https://dev-stabilizer.preview.emergentagent.com/health
...
│  https://dev-stabilizer.preview.emergentagent.com │
└───────────────────────┬─────────────────────────────┘
                        │
                        ▼
┌─────────────────────────────────────────────────────┐
