...
### Analyse
```
Browser → https://postulant-app.preview.emergentagent.com/api/besoins
          ↓
...
### Preuve
```bash
curl https://postulant-app.preview.emergentagent.com/health
...
│  https://postulant-app.preview.emergentagent.com │
└───────────────────────┬─────────────────────────────┘
                        │
                        ▼
┌─────────────────────────────────────────────────────┐
