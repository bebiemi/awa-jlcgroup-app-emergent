...
### Analyse
```
Browser → https://iam-access-fix.preview.emergentagent.com/api/besoins
          ↓
...
### Preuve
```bash
curl https://iam-access-fix.preview.emergentagent.com/health
...
│  https://iam-access-fix.preview.emergentagent.com │
└───────────────────────┬─────────────────────────────┘
                        │
                        ▼
┌─────────────────────────────────────────────────────┐
