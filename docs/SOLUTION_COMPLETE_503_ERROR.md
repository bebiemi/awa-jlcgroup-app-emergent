...
### Analyse
```
Browser → https://docker-iam-fixer.preview.emergentagent.com/api/besoins
          ↓
...
### Preuve
```bash
curl https://docker-iam-fixer.preview.emergentagent.com/health
...
│  https://docker-iam-fixer.preview.emergentagent.com │
└───────────────────────┬─────────────────────────────┘
                        │
                        ▼
┌─────────────────────────────────────────────────────┐
