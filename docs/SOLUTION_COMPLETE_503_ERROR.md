...
### Analyse
```
Browser → https://role-based-security.preview.emergentagent.com/api/besoins
          ↓
...
### Preuve
```bash
curl https://role-based-security.preview.emergentagent.com/health
...
│  https://role-based-security.preview.emergentagent.com │
└───────────────────────┬─────────────────────────────┘
                        │
                        ▼
┌─────────────────────────────────────────────────────┐
