  ...
  return (
    <SidebarProvider>
      ...
      <Route
        ...
        element={
          <ProtectedRoute requiredPermissions={['missions.edit.all', 'missions.edit.own']}>
            <EditMissionPage />
          </ProtectedRoute>
        }
      />
      ...
      <Route
        ...
        element={
          <ProtectedRoute requiredPermissions={['besoins.read', 'besoins.view.all', 'besoins.view.own']}>
            <BesoinsListPage />
          </ProtectedRoute>
        }
      />
      ...
      <Route
        ...
        element={
          <ProtectedRoute requiredPermissions={['besoins.read', 'besoins.view.all', 'besoins.view.own', 'besoins.view_all', 'besoins.view_own']}>
            <BesoinDetailPage />
          </ProtectedRoute>
        }
      />
      <Route
        ...
        element={
          <ProtectedRoute requiredPermissions={['besoins.edit.all', 'besoins.edit.own', 'besoins.edit_all', 'besoins.edit_own']}>
            <CreateBesoinPage />
          </ProtectedRoute>
        }
      />
