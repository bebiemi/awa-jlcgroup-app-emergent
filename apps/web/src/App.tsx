...
import ValidationsPageOld from './features/admin/pages/ValidationsPageNew'
...
import MissionsPageOld from './features/missions/pages/MissionsPageNew'
  ...
  return (
    <RootLayout>
      ...
      <Route
        path="/entreprise"
        element={
          <ProtectedRoute requiredPermissions={['dashboard.company.access']}>
            <CompanyDashboard />
          </ProtectedRoute>
        }
      />
