  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        {/* Modal */}
        <div className="relative bg-white rounded-xl shadow-2xl max-w-md w-full p-8 z-10">
          {/* Close Button */}
          <button
            onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-jlc-purple-500 focus:border-transparent"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-jlc-purple-600 to-jlc-purple-700 text-white py-3 px-6 rounded-lg font-semibold hover:from-jlc-purple-700 hover:to-jlc-purple-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
            >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 text-gray-700 py-3 px-6 rounded-lg font-semibold hover:bg-gray-50 transition-all"
          >
