...
async def main():
    ...
    missions = [
        # Missions TechCorp
        {
            ...
            "required_skills": ["React", "FastAPI", "Python", "JavaScript"],
            "contract_type": "CDI",
            "location": "Libreville",
        ...
        # Missions Construction Plus
        {
            ...
            "required_skills": ["Gestion de chantier", "BTP", "Management"],
            "contract_type": "CDD",
        ...
        },
        {
            ...
            "required_skills": ["Génie civil", "AutoCAD", "Gestion de projet"],
            "contract_type": "CDI",
            "location": "Port-Gentil",
        ...
        # Missions Santé Services
        {
            ...
            "required_skills": ["Soins infirmiers", "Diplôme d'État"],
            "contract_type": "CDI",
            "location": "Libreville",
    ...
    besoins = [
        ...
        },
        {
            ...
            "responsable_besoin_id": (await db.users.find_one({"username": "admin"}))["id"],
            "status_history": [],
            "mission_ids": [],
            "pieces_jointes": [],
            "custom_fields": {},
