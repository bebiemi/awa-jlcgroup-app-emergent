...
from entreprise_grouping_routes import grouping_router
...
app.include_router(entreprise_form_config_router, prefix="/api", tags=["Entreprise Form Config"])
app.include_router(grouping_router, prefix="/api", tags=["Entreprise Grouping"])
